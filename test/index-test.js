...
describe(__filename, function() {
    ...
    it('should load JS on Browser and fire beacon', function(done) {
        ...
        app.on('bowserPayload', (bowserPayload)=> {
            var pload = {"logs":[{"level":"LOG","msg":"Hello, Logging Data!!"},{"level":"LOG","msg":"Hello from console.log"},{"level":"ERROR","msg":"Hello from console.error"},{"level":"INFO","msg":"Hello from console.info"}],"ebay":{"rlogid":"t6klaook%60b0%3D%3C%3Dosuojbnkmcc4%3B(73766%3F7-161da07d39a-0x602","pageName":"DefaultPage"},"userAgent":"MSIE 9"};
